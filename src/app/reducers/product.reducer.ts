...
import { getCategoryActionSuscess, getRewiewsActionSuscess, productActionSuscess, saveProductActionSuscess, saveProductRewiewActionSuscess } from '../actions/product.action';
...
export const productReducer = createReducer(
  ...
  on(getCategoryActionSuscess, (state, { items }) => ({...state, cate: items})),
);
